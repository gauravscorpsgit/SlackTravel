...
var dbConfig = {
  rethinkDBAuth :'AUbDSJcg5E4TeRmwNKFxRazQCmSlWOx4sxj8-iRDcsI',
  host: process.env.RDB_HOST || 'localhost',
  port: parseInt(process.env.RDB_PORT) || 28015,
  db  : process.env.RDB_DB || 'slacktravel',
  tables: {
    'messages': 'id',
    'cache': 'cid',
    'users': 'id',
...
module.exports.setup = function() {
   r.connect( {host: 'localhost', port: 28015,username :'admin',password:dbConfig.rethinkDBAuth, db : 'slacktravel'}, function (err, connection) {
